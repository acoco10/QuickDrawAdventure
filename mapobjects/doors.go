...
func CheckEntDoor(player *entities.Player, entdoors map[string]Door, exdoors map[string]Door) bool {
...
func CheckExDoor(player *entities.Player, entdoors map[string]Door, exdoors map[string]Door) bool {
