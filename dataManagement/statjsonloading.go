...
func LoadSkills() (combatSkills map[string]Skill, dialogueSkills map[string]Skill, err error) {
	combatSkills, err = LoadSkillsFromPath("dataManagement/data/combatSkills.JSON")
	if err != nil {
		return combatSkills, dialogueSkills, err
	}
	dialogueSkills, err = LoadSkillsFromPath("dataManagement/data/dialogueSkills.JSON")
	if err != nil {
		return combatSkills, dialogueSkills, err
	}
