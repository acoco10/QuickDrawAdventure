...
func NewCharacter(name string, stats map[string]int, combatSkills map[string]Skill, dialogueSkills map[string]Skill) Character {
...
func (pc *Character) AssignCharStatusEffect(effect StatusEffect) {
	pc.Status = append(pc.Status, effect)
}
